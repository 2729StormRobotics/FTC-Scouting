		...
		public void action () throws IOException
		{
			create.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					dbData[1] = ramp.getText().toString();
					dbData[2] = kick.getText().toString();
					dbData[3] = centerauto.getText().toString();
					dbData[4] = rollingauto.getText().toString();
					dbData[5] = rgtopz.getText().toString();
					dbData[6] = thirtycm.getText().toString();
					dbData[7] = sixtycm.getText().toString();
					dbData[8] = nintycm.getText().toString();
					dbData[9] = botrgtopz.getText().toString();
					dbData[10] = botrgoff.getText().toString();
					dbData[11] = centerend.getText().toString();
